  ...
  return (
    <Modelo className="ToolBar">
      <Container className="Shape">
        ...
        <BotaoThickness onClick={() => setLinha("square")}>
          SQUARE
        </BotaoThickness>
      </Container>
      <Container className="ContainerTexto">
        <input
          className="TextoGrossura"
          type="number"
          value={Espessura}
      ...
      <Container>
        <BotaoCores
          onClick={() => setCor("#720474")}
          className="Roxo"
        ></BotaoCores>
        <BotaoCores
          onClick={() => setCor("#e9e803")}
          className="Amarelo"
        ></BotaoCores>
        <BotaoCores
          onClick={() => setCor("#6593ca")}
          className="Azul"
        ></BotaoCores>
        <BotaoCores
          onClick={() => setCor("#088446")}
          className="Verde"
        ></BotaoCores>
        <BotaoCores
          onClick={() => setCor("#dd4f06")}
          className="Laranja"
        ></BotaoCores>
        <BotaoCores
          onClick={() => setCor("#f1f1f1")}
          className="Branco"
        ></BotaoCores>
      </Container>
    </Modelo>
